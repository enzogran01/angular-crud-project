...
export class App {
  ...
  constructor(private http: HttpClient) {
    this.apiURL = 'https://apitarefaspedro230814.onrender.com';
    this.READ_tarefas();
  }
  ...
  READ_tarefas() {
    this.http.get<Tarefa[]>(`${this.apiURL}/api/getAll`).subscribe(resultado => this.arrayDeTarefas.set(resultado));
  }
  ...
  UPDATE_tarefa(tarefaAserModificada: Tarefa) {
    ...
    tarefaAserModificada).subscribe(resultado => { console.log(resultado); this.READ_tarefas(); });
  }
}
